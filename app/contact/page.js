    ...
    <main>
      ...
      <section className="grid gap-5 px-5 py-20 md:grid-cols-3 md:px-14">
        <article className={card}>
          ...
          <h3 className="mt-5 text-2xl font-black text-[#10201d]">Call</h3>
          <a className="mt-3 inline-flex font-black text-[#096454]" href="tel:+917200045559">+91 72000 45559</a>
        </article>
        <article className={card}>
          <Mail className="text-[#0f8d7a]" />
          <h3 className="mt-5 text-2xl font-black text-[#10201d]">Email</h3>
          <a className="mt-3 inline-flex font-black text-[#096454]" href="mailto:hello@healboxx.com">hello@healboxx.com</a>
        </article>
        <article className={card}>
          <MapPin className="text-[#0f8d7a]" />
          <h3 className="mt-5 text-2xl font-black text-[#10201d]">Mode</h3>
          <p className="mt-3 leading-7 text-[#63706d]">Online counselling and workplace wellness sessions.</p>
        </article>
      </section>
      <SiteFooter />
    </main>
