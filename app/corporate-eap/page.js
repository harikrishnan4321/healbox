...
export default function CorporatePage() {
  return (
    <main>
      ...
      <section className="flex flex-col gap-5 bg-[#10201d] px-5 py-20 text-white md:flex-row md:items-center md:justify-between md:px-14">
        <h2 className="max-w-3xl text-4xl font-black leading-none md:text-6xl">Plan an EAP session for your organisation.</h2>
        <Link className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#0f8d7a] to-[#13aa91] px-5 font-black text-white shadow-lg" href="/hello">Talk to HealBoxx <ArrowRight size={18} /></Link>
      </section>
      <SiteFooter />
    </main>
  );
